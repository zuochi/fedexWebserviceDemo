...
public class SignatureProofOfDeliveryImageType implements java.io.Serializable {
    ...
    // Constructor
    protected SignatureProofOfDeliveryImageType(String value) {
        _value_ = value;
    ...
    public static SignatureProofOfDeliveryImageType fromValue(String value)
    ...
    public static SignatureProofOfDeliveryImageType fromString(String value)
          throws IllegalArgumentException {
