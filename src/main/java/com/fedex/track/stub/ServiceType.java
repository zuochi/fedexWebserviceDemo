...
public class ServiceType implements java.io.Serializable {
    ...
    // Constructor
    protected ServiceType(String value) {
        _value_ = value;
    ...
    public static final String _FEDEX_CARGO_AIRPORT_TO_AIRPORT = "FEDEX_CARGO_AIRPORT_TO_AIRPORT";
    public static final String _FEDEX_CARGO_FREIGHT_FORWARDING = "FEDEX_CARGO_FREIGHT_FORWARDING";
    public static final String _FEDEX_CARGO_INTERNATIONAL_EXPRESS_FREIGHT = "FEDEX_CARGO_INTERNATIONAL_EXPRESS_FREIGHT";
    public static final String _FEDEX_CARGO_INTERNATIONAL_PREMIUM = "FEDEX_CARGO_INTERNATIONAL_PREMIUM";
    public static final String _FEDEX_CARGO_MAIL = "FEDEX_CARGO_MAIL";
    public static final String _FEDEX_CARGO_REGISTERED_MAIL = "FEDEX_CARGO_REGISTERED_MAIL";
    public static final String _FEDEX_CARGO_SURFACE_MAIL = "FEDEX_CARGO_SURFACE_MAIL";
    public static final String _FEDEX_CUSTOM_CRITICAL_AIR_EXPEDITE = "FEDEX_CUSTOM_CRITICAL_AIR_EXPEDITE";
    public static final String _FEDEX_CUSTOM_CRITICAL_AIR_EXPEDITE_EXCLUSIVE_USE = "FEDEX_CUSTOM_CRITICAL_AIR_EXPEDITE_EXCLUSIVE_USE";
    public static final String _FEDEX_CUSTOM_CRITICAL_AIR_EXPEDITE_NETWORK = "FEDEX_CUSTOM_CRITICAL_AIR_EXPEDITE_NETWORK";
    public static final String _FEDEX_CUSTOM_CRITICAL_CHARTER_AIR = "FEDEX_CUSTOM_CRITICAL_CHARTER_AIR";
    public static final String _FEDEX_CUSTOM_CRITICAL_POINT_TO_POINT = "FEDEX_CUSTOM_CRITICAL_POINT_TO_POINT";
    public static final String _FEDEX_CUSTOM_CRITICAL_SURFACE_EXPEDITE = "FEDEX_CUSTOM_CRITICAL_SURFACE_EXPEDITE";
    public static final String _FEDEX_CUSTOM_CRITICAL_SURFACE_EXPEDITE_EXCLUSIVE_USE = "FEDEX_CUSTOM_CRITICAL_SURFACE_EXPEDITE_EXCLUSIVE_USE";
    public static final String _FEDEX_CUSTOM_CRITICAL_TEMP_ASSURE_AIR = "FEDEX_CUSTOM_CRITICAL_TEMP_ASSURE_AIR";
    public static final String _FEDEX_CUSTOM_CRITICAL_TEMP_ASSURE_VALIDATED_AIR = "FEDEX_CUSTOM_CRITICAL_TEMP_ASSURE_VALIDATED_AIR";
    public static final String _FEDEX_CUSTOM_CRITICAL_WHITE_GLOVE_SERVICES = "FEDEX_CUSTOM_CRITICAL_WHITE_GLOVE_SERVICES";
    ...
    public static final String _TRANSBORDER_DISTRIBUTION_CONSOLIDATION = "TRANSBORDER_DISTRIBUTION_CONSOLIDATION";
